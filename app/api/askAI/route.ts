    ...
    messages: [
      {
        ...
        content: `
          ...
          the description of the scene or character that you will draw will be in the format of danbooru tags with additional one short sentense about the subject movement.
