...
export default function TextLayoutMenu({fontSize, setFontSize, lineSpace, setLineSpace} : {fontSize: number, setFontSize: (fontSize: number) => void, lineSpace: number, setLineSpace: (lineSpace: number) => void}) {
