import { Box, Button, Grid, Pagination, Stack, Typography, styled } from '@mui/material';
...
const TxtViewer = ({
  ...
  return (
    <>
      <Box display="flex" justifyContent="flex-end" minHeight="100%" width="100%">
        <TextLayoutMenu
          fontSize={fontSize}
      ...
      <Grid container justifyContent="center" alignItems="center">
        <Grid item lg={6} xs={12} flex={1} flexWrap="wrap" marginBottom={5} marginTop={5}>
        ...
        >
          {imageUrl ? (
            ...
            <Lottie animationData={loadingJson} loop play style={{ width: 180, height: 180 }} />
          )}
        </Grid>
      </Grid>
      <Stack alignItems="center" direction="column" justifyContent="center" spacing={3}>
        <CssPagination
          ...
          variant="outlined"
        />
        <Stack direction="row" flexWrap="wrap" spacing={{ xs: 1, sm: 2 }} useFlexGap>
          <CssTextField
            id="jumpPage"
            label="Jump to Page"
            size="small"
